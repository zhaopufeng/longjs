...
export async function proxyTable(ctx: Core.Context, options: ProxyTableOptions = {}) {
...
export default class ProxyTable {
    public _proxy: httpProxy = _proxy
    constructor(public options: ProxyTableOptions) {}
...
export interface ProxyTableOptions {
